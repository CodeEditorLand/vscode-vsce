...
export async function search(
	...
	const results = (await api.extensionQuery({
		...
		criteria: [
			...
			{
				filterType: ExtensionQueryFilterType.ExcludeWithFlags,
				value: excludeFlags,
			},
		],
		flags: [
...
function buildResultTableView(
	results: VSCodePublishedExtension[],
	stats: boolean,
): string[] {
...
function buildExtensionStatisticsText(
